<?php   
    ...
    class StudentController{
        ...
        { 
            ...
            $fullname = $getImages['data']['first_name'] .' '. $getImages['data']['last_name'];  
            $studentno = $getImages['data']['student_number'];  
            $section = $getImages['data']['section'];
            return array("time_in" => true, "status" => 200, "message" => "Time in successful.", "fullname" => $fullname, "image" =>$image, "studentnumber" => $studentno, "section" => $section, $getImages);
